...
def init_game_state():
    ...
    return {
        ...
        'properties': [
            ...
            {'name': 'Social Media', 'price': 2500000, 'rent': 500000, 'owner': None},
            ...
            {'name': 'Email Marketing', 'price': 2500000, 'rent': 500000, 'owner': None},
            {'name': 'CHANCE', 'price': 0, 'rent': 0, 'owner': None},
            {'name': 'SEO', 'price': 3000000, 'rent': 1000000, 'owner': None},
            {'name': 'MYSTERY WHEEL', 'price': 0, 'rent': 0, 'owner': None},
            {'name': 'PPC Advertising', 'price': 3500000, 'rent': 1000000, 'owner': None},
            {'name': 'Free Parking', 'price': 0, 'rent': 0, 'owner': None},
            {'name': 'Influencer Marketing', 'price': 3000000, 'rent': 1000000, 'owner': None},
            {'name': 'MYSTERY WHEEL', 'price': 0, 'rent': 0, 'owner': None},
            {'name': 'Brand Management', 'price': 3500000, 'rent': 1000000, 'owner': None},
            {'name': 'CHANCE', 'price': 0, 'rent': 0, 'owner': None},
            {'name': 'Event Management', 'price': 2500000, 'rent': 500000, 'owner': None},
            {'name': 'Event Penalty', 'price': 0, 'rent': 0, 'owner': None},
            {'name': 'Market Research', 'price': 3000000, 'rent': 1000000, 'owner': None},
            {'name': 'CHANCE', 'price': 0, 'rent': 0, 'owner': None},
